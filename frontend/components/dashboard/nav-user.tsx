            ...
            <SidebarMenuItem>
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            <div
                                className={`h-8 w-8 rounded-lg ${bgColor} flex items-center justify-center text-white text-xl font-medium`}
                            >
                                {getInitial()}
                            </div>
                        </SidebarMenuButton>
                    ...
                    >
                        <DropdownMenuLabel className="p-0 font-normal">
                            <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                                <div
                                    className={`h-8 w-8 rounded-lg ${bgColor} flex items-center justify-center text-white font-medium`}
                                >
                                    {getInitial()}
                                </div>
