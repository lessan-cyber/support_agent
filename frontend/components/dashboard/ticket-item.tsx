...
export function TicketItem({
    ...
    const getAvatarColor = () => {
        ...
        if (conversation.lastMessageSender === "bot")
    ...
    return (
        ...
        >
            <div className="flex gap-3 items-start">
                {/* Avatar */}
                <Avatar
                    className={`w-9 h-9 rounded-full flex items-center justify-center font-semibold text-sm flex-shrink-0 ${getAvatarColor()}`}
                >
                    {initial}
                </Avatar>
