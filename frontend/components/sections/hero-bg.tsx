...
export const HeroBackground = ({
    ...
    return (
        ...
        <div
            ...
            {/* --- NOUVEAU : Effet d'interpénétration (Gradient Fade) --- */}
            {/* Adaptez 'to-background' si votre classe bg-background utilise une couleur spécifique. */}
            <div className="absolute bottom-0 left-0 right-0 h-48 bg-linear-to-b from-transparent to-white dark:from-transparent dark:to-background pointer-events-none z-0" />
            {/* ---------------------------------------------------------- */}
