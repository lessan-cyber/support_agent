...
export default function DataPage() {
  ...
  const handleExportData = async () => {
    ...
    try {
      ...
      toast.success("Your data has been exported successfully.", { position: "top-right" })
    } catch (error) {
  ...
  const handleDeleteAllDocuments = async () => {
    ...
    try {
      ...
      toast.success("All your documents have been deleted.", { position: "top-right" })

      router.push("/dashboard/documents")
    } catch (error) {
      toast.error("Failed to delete documents. Please try again.", { position: "top-right" }) 
    } finally {
  ...
  const handleDeleteAccount = async () => {
    if (confirmText !== "DELETE") {
      toast.warning("Please type DELETE to confirm.", { position: "top-right" })
      return
    }
    ...
    try {
      ...
      toast.info("Your account has been permanently deleted.", { position: "top-right" })
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Download a copy of all your data including profile, documents, and settings
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="border-orange-200 dark:border-orange-900">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-orange-600">Delete All Documents</CardTitle>
          </div>
          <CardDescription>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will permanently delete all your uploaded documents. This action cannot be
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will permanently delete your account, all your documents, and all associated
